def banana():
    ...
    Lees dit bericht niet hardop voor. Als de patiënt een zeer eenvoudige beschrijving geeft, kun je vragen om meer details of hints geven over wat hij of zij nog meer kan beschrijven.
...
def family():
    ...
    Meer detail zou zijn: "Ik zie een gezin van vier personen: twee ouders en twee kinderen (een moeder, een vader, een dochter en een zoon)."
    """
    return eval_prompt
...
def astronaut():
    ...
    Meer detail zou zijn: "Ik zie een robot die op een raket staat."
    Nog meer detail zou zijn: "Ik zie een robot die op een raket staat. Hij draagt een wit pak."
    """
    return eval_prompt